...
//
// On Thu Jul  4 08:48:22 EDT 2024
//
//
// Ports:
// Name                         I/O  size props
...
module mkCache32(CLK,
  ...
  wire [63 : 0] w_en__h6221;
  wire [31 : 0] n__h9037, x__h6330;
  wire [25 : 0] x_addr__h4887;
  ...
  assign MUX_cache_data_serverAdapter_writeWithResp$wset_1__VAL_1 =
	     { w_en__h6221 != 64'd0, w_en__h6221 == 64'd0 } ;
  ...
  assign MUX_memReqQ$enq_1__VAL_1 = { 1'b1, x_addr__h4887, x_data__h4888 } ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_cache_data_memory$put_1__SEL_1: cache_data_memory$WE = w_en__h6221;
  ...
  assign IF_curReq_23_BITS_37_TO_34_63_EQ_15_31_THEN_IF_ETC___d250 =
	     { (curReq[37:34] == 4'd15) ? n__h9037 : memRespQ$D_OUT[511:480],
	       (curReq[37:34] == 4'd14) ? n__h9037 : memRespQ$D_OUT[479:448],
	       (curReq[37:34] == 4'd13) ? n__h9037 : memRespQ$D_OUT[447:416],
	       (curReq[37:34] == 4'd12) ?
		 n__h9037 :
  ...
  assign IF_curReq_23_BITS_37_TO_34_63_EQ_15_31_THEN_IF_ETC___d255 =
	     { IF_curReq_23_BITS_37_TO_34_63_EQ_15_31_THEN_IF_ETC___d250,
	       (curReq[37:34] == 4'd11) ? n__h9037 : memRespQ$D_OUT[383:352],
	       (curReq[37:34] == 4'd10) ?
		 n__h9037 :
  ...
  assign IF_curReq_23_BITS_37_TO_34_63_EQ_15_31_THEN_IF_ETC___d260 =
	     { IF_curReq_23_BITS_37_TO_34_63_EQ_15_31_THEN_IF_ETC___d255,
	       (curReq[37:34] == 4'd9) ? n__h9037 : memRespQ$D_OUT[319:288],
	       (curReq[37:34] == 4'd8) ?
		 n__h9037 :
  ...
  assign IF_curReq_23_BITS_37_TO_34_63_EQ_15_31_THEN_IF_ETC___d265 =
	     { IF_curReq_23_BITS_37_TO_34_63_EQ_15_31_THEN_IF_ETC___d260,
	       (curReq[37:34] == 4'd7) ? n__h9037 : memRespQ$D_OUT[255:224],
	       (curReq[37:34] == 4'd6) ?
		 n__h9037 :
  ...
  assign IF_curReq_23_BITS_37_TO_34_63_EQ_15_31_THEN_IF_ETC___d270 =
	     { IF_curReq_23_BITS_37_TO_34_63_EQ_15_31_THEN_IF_ETC___d265,
	       (curReq[37:34] == 4'd5) ? n__h9037 : memRespQ$D_OUT[191:160],
	       (curReq[37:34] == 4'd4) ?
		 n__h9037 :
  ...
  assign IF_curReq_23_BITS_37_TO_34_63_EQ_15_31_THEN_IF_ETC___d275 =
	     { IF_curReq_23_BITS_37_TO_34_63_EQ_15_31_THEN_IF_ETC___d270,
	       (curReq[37:34] == 4'd3) ? n__h9037 : memRespQ$D_OUT[127:96],
	       (curReq[37:34] == 4'd2) ? n__h9037 : memRespQ$D_OUT[95:64] } ;
  assign IF_curReq_23_BITS_37_TO_34_63_EQ_15_31_THEN_IF_ETC___d280 =
	     { IF_curReq_23_BITS_37_TO_34_63_EQ_15_31_THEN_IF_ETC___d275,
	       (curReq[37:34] == 4'd1) ? n__h9037 : memRespQ$D_OUT[63:32],
	       (curReq[37:34] == 4'd0) ? n__h9037 : memRespQ$D_OUT[31:0] } ;
  ...
  assign n__h9037 =
	     { curReq[67] ? curReq[31:24] : indexed_word__h7466[31:24],
	       curReq[66] ? curReq[23:16] : indexed_word__h7466[23:16],
	       curReq[65] ? curReq[15:8] : indexed_word__h7466[15:8],
	       curReq[64] ? curReq[7:0] : indexed_word__h7466[7:0] } ;
  assign respQ_i_notFull__27_AND_curReq_23_BITS_67_TO_6_ETC___d131 =
	     respQ$FULL_N &&
	     (curReq[67:64] == 4'b0 ||
	      cache_metadata_serverAdapter_cnt_5_SLT_3___d99 &&
	      cache_data_serverAdapter_cnt_5_SLT_3___d100) ;
  assign w_en__h6221 = { 60'd0, curReq[67:64] } << x__h6308 ;
  assign x__h6308 = { curReq[37:34], 2'b0 } ;
  assign x__h6330 =
	     { curReq[67] ?
		 curReq[31:24] :
  ...
  assign x__h7269 = { curReq[37:34], 5'b0 } ;
  assign x_addr__h4887 =
	     { IF_cache_metadata_serverAdapter_outData_ff_i_n_ETC___d122,
	       curReq[44:38] } ;
  assign x_data__h4888 =
	     cache_data_serverAdapter_outData_ff$EMPTY_N ?
	       cache_data_serverAdapter_outData_ff$D_OUT :
  ...
  begin
    case (curReq[37:34])
      4'd0: indexed_word__h7466 = memRespQ$D_OUT[31:0];
      4'd1: indexed_word__h7466 = memRespQ$D_OUT[63:32];
      4'd2: indexed_word__h7466 = memRespQ$D_OUT[95:64];
      4'd3: indexed_word__h7466 = memRespQ$D_OUT[127:96];
      4'd4: indexed_word__h7466 = memRespQ$D_OUT[159:128];
      4'd5: indexed_word__h7466 = memRespQ$D_OUT[191:160];
      4'd6: indexed_word__h7466 = memRespQ$D_OUT[223:192];
      4'd7: indexed_word__h7466 = memRespQ$D_OUT[255:224];
      4'd8: indexed_word__h7466 = memRespQ$D_OUT[287:256];
      4'd9: indexed_word__h7466 = memRespQ$D_OUT[319:288];
      4'd10: indexed_word__h7466 = memRespQ$D_OUT[351:320];
      4'd11: indexed_word__h7466 = memRespQ$D_OUT[383:352];
      4'd12: indexed_word__h7466 = memRespQ$D_OUT[415:384];
      4'd13: indexed_word__h7466 = memRespQ$D_OUT[447:416];
      4'd14: indexed_word__h7466 = memRespQ$D_OUT[479:448];
      4'd15: indexed_word__h7466 = memRespQ$D_OUT[511:480];
    endcase
  end
  always@(curReq or x_data__h4888)
  begin
    case (curReq[37:34])
      4'd0:
	  SEL_ARR_IF_cache_data_serverAdapter_outData_ff_ETC___d164 =
      ...
      4'd3:
	  SEL_ARR_IF_cache_data_serverAdapter_outData_ff_ETC___d164 =
	      x_data__h4888[127:96];
      4'd4:
	  SEL_ARR_IF_cache_data_serverAdapter_outData_ff_ETC___d164 =
	      x_data__h4888[159:128];
      4'd5:
	  SEL_ARR_IF_cache_data_serverAdapter_outData_ff_ETC___d164 =
	      x_data__h4888[191:160];
      4'd6:
	  SEL_ARR_IF_cache_data_serverAdapter_outData_ff_ETC___d164 =
	      x_data__h4888[223:192];
      4'd7:
	  SEL_ARR_IF_cache_data_serverAdapter_outData_ff_ETC___d164 =
	      x_data__h4888[255:224];
      4'd8:
	  SEL_ARR_IF_cache_data_serverAdapter_outData_ff_ETC___d164 =
	      x_data__h4888[287:256];
      4'd9:
	  SEL_ARR_IF_cache_data_serverAdapter_outData_ff_ETC___d164 =
	      x_data__h4888[319:288];
      4'd10:
	  SEL_ARR_IF_cache_data_serverAdapter_outData_ff_ETC___d164 =
	      x_data__h4888[351:320];
      4'd11:
	  SEL_ARR_IF_cache_data_serverAdapter_outData_ff_ETC___d164 =
	      x_data__h4888[383:352];
      4'd12:
	  SEL_ARR_IF_cache_data_serverAdapter_outData_ff_ETC___d164 =
	      x_data__h4888[415:384];
      4'd13:
	  SEL_ARR_IF_cache_data_serverAdapter_outData_ff_ETC___d164 =
	      x_data__h4888[447:416];
      4'd14:
	  SEL_ARR_IF_cache_data_serverAdapter_outData_ff_ETC___d164 =
	      x_data__h4888[479:448];
      4'd15:
	  SEL_ARR_IF_cache_data_serverAdapter_outData_ff_ETC___d164 =
	      x_data__h4888[511:480];
    endcase
  end
