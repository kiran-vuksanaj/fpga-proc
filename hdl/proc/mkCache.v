...
module mkCache(CLK,
  ...
  wire [511 : 0] din_datain_data__h3132, x__h2663;
  wire [17 : 0] IF_lines_serverAdapter_outData_ff_i_notEmpty_T_ETC___d75;
  wire [2 : 0] lines_serverAdapter_cnt_5_PLUS_IF_lines_server_ETC___d21;
  wire [1 : 0] IF_lines_serverAdapter_outData_ff_i_notEmpty_T_ETC___d69;
  wire IF_lines_serverAdapter_outData_ff_i_notEmpty_T_ETC___d78,
       lines_serverAdapter_cnt_5_SLT_3___d48,
       lines_serverAdapter_outData_beforeDeq_read__2__ETC___d62;

  // action method putFromProc
  assign RDY_putFromProc =
	     reqStatus == 3'd1 && lines_serverAdapter_cnt_5_SLT_3___d48 ;
  ...
  assign WILL_FIRE_RL_clear_bram =
	     lines_serverAdapter_cnt_5_SLT_3___d48 && reqStatus == 3'd0 ;
  ...
  assign WILL_FIRE_RL_waitFillResp =
	     lines_serverAdapter_cnt_5_SLT_3___d48 && memRespQ$EMPTY_N &&
	     respQ$FULL_N &&
	     reqStatus == 3'd4 ;
  ...
  assign MUX_lines_memory$put_1__SEL_1 =
	     ...
	     IF_lines_serverAdapter_outData_ff_i_notEmpty_T_ETC___d69 !=
	     2'd0 &&
	     IF_lines_serverAdapter_outData_ff_i_notEmpty_T_ETC___d78 &&
	     curReq[538] ;
  ...
  assign MUX_lines_memory$put_3__VAL_1 =
	     { 2'd2,
	       IF_lines_serverAdapter_outData_ff_i_notEmpty_T_ETC___d75,
	       curReq[511:0] } ;
  assign MUX_lines_memory$put_3__VAL_4 =
	     { curReq[538] ? 2'd2 : 2'd1,
	       curReq[537:520],
	       din_datain_data__h3132 } ;
  ...
  // remaining internal signals
  assign IF_lines_serverAdapter_outData_ff_i_notEmpty_T_ETC___d69 =
	     lines_serverAdapter_outData_ff$EMPTY_N ?
	       lines_serverAdapter_outData_ff$D_OUT[531:530] :
	       lines_memory$DO[531:530] ;
  assign IF_lines_serverAdapter_outData_ff_i_notEmpty_T_ETC___d75 =
	     lines_serverAdapter_outData_ff$EMPTY_N ?
	       lines_serverAdapter_outData_ff$D_OUT[529:512] :
	       lines_memory$DO[529:512] ;
  assign IF_lines_serverAdapter_outData_ff_i_notEmpty_T_ETC___d78 =
	     IF_lines_serverAdapter_outData_ff_i_notEmpty_T_ETC___d75 ==
	     curReq[537:520] ;
  assign din_datain_data__h3132 =
  ...
  assign lines_serverAdapter_cnt_5_SLT_3___d48 =
	     (lines_serverAdapter_cnt ^ 3'h4) < 3'd7 ;
  assign lines_serverAdapter_outData_beforeDeq_read__2__ETC___d62 =
	     lines_serverAdapter_outData_beforeDeq$Q_OUT &&
	     (lines_serverAdapter_outData_ff$EMPTY_N ||
	      lines_serverAdapter_outData_enqw$whas) &&
	     lines_serverAdapter_cnt_5_SLT_3___d48 &&
	     respQ$FULL_N &&
	     memReqQ$FULL_N ;
  assign x__h2663 = MUX_respQ$enq_1__VAL_2 ;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  !IF_lines_serverAdapter_outData_ff_i_notEmpty_T_ETC___d78 &&
	  IF_lines_serverAdapter_outData_ff_i_notEmpty_T_ETC___d69 == 2'd2)
