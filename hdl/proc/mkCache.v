...
module mkCache(CLK,
  ...
  wire [511 : 0] din_datain_data__h3032, x__h2628;
  wire [25 : 0] x_addr__h2802;
  ...
  assign MUX_lines_memory$put_3__VAL_4 =
	     { curReq[538] ? 2'd2 : 2'd1,
	       curReq[537:520],
	       din_datain_data__h3032 } ;
  assign MUX_memReqQ$enq_1__VAL_1 = { 1'b1, x_addr__h2802, x__h2628 } ;
  ...
  assign x__h2628 = MUX_respQ$enq_1__VAL_2 ;
  assign x_addr__h2802 =
	     { IF_lines_serverAdapter_outData_ff_i_notEmpty_T_ETC___d70,
	       curReq[519:512] } ;
