...
module mkProcCore(CLK,
  ...
  wire RDY_getMMIOReq, RDY_getMReq, RDY_putMMIOResp, RDY_putMResp;
  ...
  // submodule cache
  mkContextCacheInterface cache(.CLK(CLK),
				.RST_N(RST_N),
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (rv_core$RDY_getIResp && cache$RDY_getRespInstr)
	$display("responseI running");
    if (RST_N != `BSV_RESET_VALUE)
      if (rv_core$RDY_getIReq && cache$RDY_sendReqInstr)
	$display("requestI running");
    if (RST_N != `BSV_RESET_VALUE)
      if (rv_core$RDY_getDResp && cache$RDY_getRespData)
	$display("responseD running");
    if (RST_N != `BSV_RESET_VALUE)
      if (rv_core$RDY_getDReq && cache$RDY_sendReqData)
	$display("requestD running");
    if (RST_N != `BSV_RESET_VALUE)
      if (cache$RDY_getMemReq && mainMemReqQ$FULL_N)
	$display("main mem req enq");
    if (RST_N != `BSV_RESET_VALUE)
      if (cache$RDY_putMemResp && mainMemRespQ$EMPTY_N)
	$display("main mem resp enq");
  end
  // synopsys translate_on
