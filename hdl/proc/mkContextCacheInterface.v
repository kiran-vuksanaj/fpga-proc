...
//
// On Wed Jun 26 09:45:23 EDT 2024
//
//
// Ports:
// Name                         I/O  size props
...
module mkContextCacheInterface(CLK,
  ...
  wire reqTypeQ_i_notEmpty__9_AND_IF_reqTypeQ_first___ETC___d24;
  ...
  assign WILL_FIRE_RL_distributeL2Resp =
	     cacheL2$RDY_getToProc &&
	     reqTypeQ_i_notEmpty__9_AND_IF_reqTypeQ_first___ETC___d24 ;
  ...
  // submodule reqTypeQ
  assign reqTypeQ$D_IN = !WILL_FIRE_RL_connectL1InstL2 ;
  assign reqTypeQ$ENQ =
	     WILL_FIRE_RL_connectL1InstL2 || WILL_FIRE_RL_connectL1DataL2 ;
  ...
  // remaining internal signals
  assign reqTypeQ_i_notEmpty__9_AND_IF_reqTypeQ_first___ETC___d24 =
	     reqTypeQ$EMPTY_N &&
  ...
  begin
    #0;
    if (RST_N != `BSV_RESET_VALUE) if (EN_putMemResp) $display("[ ]   <");
    if (RST_N != `BSV_RESET_VALUE) if (EN_getMemReq) $display("[ ]   >");
    if (RST_N != `BSV_RESET_VALUE) if (EN_sendReqData) $display("[D]>");
    if (RST_N != `BSV_RESET_VALUE) if (EN_getRespData) $display("[D]<\n");
    if (RST_N != `BSV_RESET_VALUE) if (EN_sendReqInstr) $display("[I]>");
    if (RST_N != `BSV_RESET_VALUE) if (EN_getRespInstr) $display("[I]<\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_connectL1InstL2) $display("[I] >");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_connectL1DataL2) $display("[D] >");
    if (RST_N != `BSV_RESET_VALUE)
      if (cacheL2$RDY_putFromProc && reqQL2$EMPTY_N) $display("[ ]  >");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_distributeL2Resp) $display("[ ]  <");
    if (RST_N != `BSV_RESET_VALUE)
      if (cacheI$RDY_putFromMem && instL2RespQ$EMPTY_N) $display("[I] <");
    if (RST_N != `BSV_RESET_VALUE)
      if (cacheD$RDY_putFromMem && dataL2RespQ$EMPTY_N) $display("[D] <");
  end
  // synopsys translate_on
