...
//
// On Mon Jul  1 14:35:51 EDT 2024
//
//
// Ports:
// Name                         I/O  size props
...
module mkpipelined(CLK,
  ...
  reg [31 : 0] rd_val__h5496, v__h6192;
  ...
  wire [31 : 0] IF_d2e_first__75_BIT_164_86_AND_IF_d2e_first___ETC___d222,
		_theResult___snd__h5017,
		_theResult___snd__h5083,
		_theResult___snd__h5102,
		addr___1__h3981,
		alu_src2__h5493,
		controlResult_nextPC__h4924,
		...
		x_wget__h1164;
  wire [20 : 0] x__h4394;
  wire [15 : 0] mem_data295_BITS_15_TO_0__q2;
  wire [12 : 0] x__h4231;
  wire [11 : 0] d2eD_OUT_BITS_160_TO_149__q3, x__h4161;
  wire [7 : 0] mem_data295_BITS_7_TO_0__q1;
  wire [4 : 0] shift_amount__h3978, x__h6333;
  wire [3 : 0] req_byte_en__h4618;
  ...
  // submodule f2d
  assign f2d$D_IN = { nextPc_register, x__h2012, currentEpoch } ;
  ...
  // submodule toDmem
  assign toDmem$D_IN =
	     { req_byte_en__h4618, addr___1__h3981, data___1__h3980 } ;
  assign toDmem$ENQ =
	     WILL_FIRE_RL_execute &&
	     currentEpoch_1_EQ_d2e_first__75_BIT_64_76___d177 &&
	     !d2e$D_OUT[135] &&
  ...
  assign NOT_scoreboard_search1_fromImem_first__5_BITS__ETC___d136 =
	     ...
	     (fromImem$D_OUT[6:2] == 5'b01101 ||
	      ...
	      fromImem$D_OUT[6:2] == 5'b00100 ||
	      fromImem$D_OUT[6:2] == 5'b00101) ;
  assign _theResult___snd__h5017 =
	     (d2e$D_OUT[131] && d2e$D_OUT[132]) ?
	       nextPC__h5019 :
	       _theResult___snd__h5083 ;
  assign _theResult___snd__h5083 =
	     (d2e$D_OUT[131] && !d2e$D_OUT[132]) ?
	       nextPC__h5085 :
	       _theResult___snd__h5102 ;
  assign _theResult___snd__h5102 =
	     IF_d2e_first__75_BITS_143_TO_141_81_EQ_0b0_82__ETC___d297 ?
	       nextPC__h5019 :
	       incPC__h4919 ;
  assign addr___1__h3981 =
	     { d2e_first__75_BITS_63_TO_32_85_PLUS_IF_d2e_fir_ETC___d225[31:2],
	       2'b0 } ;
  assign alu_src2__h5493 = d2e$D_OUT[134] ? d2e$D_OUT[31:0] : imm__h3842 ;
  assign controlResult_nextPC__h4924 =
  ...
  assign d2e_i_notEmpty__74_AND_NOT_currentEpoch_1_EQ_d_ETC___d238 =
	     ...
	     (!currentEpoch_1_EQ_d2e_first__75_BIT_64_76___d177 ||
	      e2w$FULL_N &&
	      d2e_first__75_BIT_135_80_OR_NOT_d2e_first__75__ETC___d235) ;
  assign data___1__h3980 = d2e$D_OUT[31:0] << shift_amount__h3978 ;
  assign data__h3847 =
  ...
  assign imm__h3842 =
		 ...
		 d2eD_OUT_BITS_160_TO_149__q3 } :
		  ...
		  { {20{x__h4161[11]}}, x__h4161 } :
		  IF_d2e_first__75_BIT_164_86_AND_IF_d2e_first___ETC___d222) ;
  assign incPC__h4919 = d2e$D_OUT[128:97] + 32'd4 ;
  assign mem_data295_BITS_15_TO_0__q2 = mem_data__h6295[15:0] ;
  assign mem_data295_BITS_7_TO_0__q1 = mem_data__h6295[7:0] ;
  assign mem_data__h6294 =
	     e2w$D_OUT[72] ? fromMMIO$D_OUT[31:0] : fromDmem$D_OUT[31:0] ;
  assign mem_data__h6295 = mem_data__h6294 >> x__h6333 ;
  assign nextPC__h5019 = d2e$D_OUT[128:97] + imm__h3842 ;
  assign nextPC__h5085 =
	     { d2e_first__75_BITS_63_TO_32_85_PLUS_IF_d2e_fir_ETC___d225[31:1],
	       1'd0 } ;
  assign req_byte_en__h4618 =
	     d2e$D_OUT[134] ?
	       CASE_d2eD_OUT_BITS_142_TO_141_0b0_0b1_SL_d2e__ETC__q5 :
	       4'd0 ;
  assign shift_amount__h3978 =
	     { d2e_first__75_BITS_63_TO_32_85_PLUS_IF_d2e_fir_ETC___d225[1:0],
	       3'b0 } ;
  assign truePpc__h4908 = fault ? 32'd0 : controlResult_nextPC__h4924 ;
  assign v__h4912 =
	     IF_d2e_first__75_BITS_135_TO_133_71_EQ_0b110_7_ETC___d304 ?
	       x1_avValue_snd_fst__h5369 :
	       incPC__h4919 ;
  assign x1_avValue_snd_fst__h5369 =
	     (!d2e$D_OUT[135] && d2e$D_OUT[133:132] == 2'b0) ?
	       data___1__h3980 :
	       data__h3847 ;
  assign x__h2012 = nextPc_register + 32'd4 ;
  assign x__h3788 = (fromImem$D_OUT[19:15] == 5'b0) ? 32'd0 : regFile$getRs1 ;
  assign x__h3797 = (fromImem$D_OUT[24:20] == 5'd0) ? 32'd0 : regFile$getRs2 ;
  assign x__h4161 = { d2e$D_OUT[160:154], d2e$D_OUT[140:136] } ;
  assign x__h4231 =
	     { d2e$D_OUT[160],
	       d2e$D_OUT[136],
	       d2e$D_OUT[159:154],
  ...
  assign x__h5649 =
	     (d2e$D_OUT[63:32] ^ 32'h80000000) <
	     (alu_src2__h5493 ^ 32'h80000000) ;
  assign x__h5656 = d2e$D_OUT[63:32] < alu_src2__h5493 ;
  assign x__h6333 = { e2w$D_OUT[74:73], 3'b0 } ;
  ...
  assign x_wget__h1164 =
	     nextPc_readBeforeLaterWrites_1$Q_OUT ?
	       ...
	       def__h1427 ;
  always@(e2w$D_OUT or
	  mem_data295_BITS_7_TO_0__q1 or
	  mem_data295_BITS_15_TO_0__q2 or mem_data__h6295)
  begin
    case (e2w$D_OUT[77:75])
      3'b0:
	  v__h6192 =
	      { {24{mem_data295_BITS_7_TO_0__q1[7]}},
		mem_data295_BITS_7_TO_0__q1 };
      3'b001:
	  v__h6192 =
	      { {16{mem_data295_BITS_15_TO_0__q2[15]}},
		mem_data295_BITS_15_TO_0__q2 };
      3'b010: v__h6192 = mem_data__h6295;
      3'b100, 3'b101: v__h6192 = { 24'd0, mem_data__h6295[7:0] };
      default: v__h6192 = e2w$D_OUT[71:40];
    endcase
  end
  always@(d2e$D_OUT or
	  alu_src2__h5493 or
	  x__h5649 or x__h5656 or d2eD_OUT_BITS_63_TO_32__q4)
  begin
    case (d2e$D_OUT[143:141])
      3'b0:
	  rd_val__h5496 =
	      (d2e$D_OUT[134] && d2e$D_OUT[159]) ?
		d2e$D_OUT[63:32] - alu_src2__h5493 :
		d2e$D_OUT[63:32] + alu_src2__h5493;
      3'b001: rd_val__h5496 = d2e$D_OUT[63:32] << alu_src2__h5493[4:0];
      3'b010: rd_val__h5496 = { 31'd0, x__h5649 };
      3'b011: rd_val__h5496 = { 31'd0, x__h5656 };
      3'b100: rd_val__h5496 = d2e$D_OUT[63:32] ^ alu_src2__h5493;
      3'b101:
	  rd_val__h5496 =
	      d2e$D_OUT[159] ?
		d2e$D_OUT[63:32] >> alu_src2__h5493[4:0] |
		~(32'hFFFFFFFF >> alu_src2__h5493[4:0]) &
		{32{d2eD_OUT_BITS_63_TO_32__q4[31]}} :
		d2e$D_OUT[63:32] >> alu_src2__h5493[4:0];
      3'b110: rd_val__h5496 = d2e$D_OUT[63:32] | alu_src2__h5493;
      3'b111: rd_val__h5496 = d2e$D_OUT[63:32] & alu_src2__h5493;
    endcase
  end
  always@(d2e$D_OUT or
	  d2e_first__75_BITS_63_TO_32_85_PLUS_IF_d2e_fir_ETC___d225)
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  !d2e$D_OUT[135] &&
	  d2e$D_OUT[133:132] == 2'b0)
	$display("[exec_mem]@%x addr=%x data=%x mmio=%d",
		 d2e$D_OUT[128:97],
		 addr___1__h3981,
		 data___1__h3980,
		 d2e_first__75_BITS_63_TO_32_85_PLUS_IF_d2e_fir_ETC___d225[31:2] ==
	...
	$display("[wb] mem=%d legal=%d rd_valid=%d, rd=%d data=%x mb_offset=%b",
		 !e2w$D_OUT[6] && e2w$D_OUT[4:3] == 2'b0,
		 e2w$D_OUT[39],
		 e2w$D_OUT[36],
		 e2w$D_OUT[11:7],
		 ...
		 e2w$D_OUT[77:75]);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_writeback && !e2w$D_OUT[6] && e2w$D_OUT[4:3] == 2'b0)
	$display("[wb] mem_data=%x", mem_data__h6295);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_writeback && !e2w$D_OUT[39]) $display("[wb] fault??");
  end
  // synopsys translate_on
