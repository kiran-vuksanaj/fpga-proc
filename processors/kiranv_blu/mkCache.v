...
module mkCache(CLK,
  ...
  reg [3 : 0] lines_serverAdapter_cnt;
  wire [3 : 0] lines_serverAdapter_cnt$D_IN;
  ...
  // register lines_serverAdapter_s2
  reg [1 : 0] lines_serverAdapter_s2;
  wire [1 : 0] lines_serverAdapter_s2$D_IN;
  wire lines_serverAdapter_s2$EN;
  ...
  wire MUX_lines_memory$put_1__SEL_1,
       MUX_memReqQ$enq_1__SEL_1,
       MUX_reqStatus$write_1__SEL_1,
       MUX_respQ$enq_1__SEL_1;

  // remaining internal signals
  wire [511 : 0] din_datain_data__h3303, x__h2832;
  wire [17 : 0] IF_lines_serverAdapter_outData_ff_i_notEmpty_T_ETC___d73;
  wire [3 : 0] lines_serverAdapter_cnt_5_PLUS_IF_lines_server_ETC___d21;
  wire [1 : 0] IF_lines_serverAdapter_outData_ff_i_notEmpty_T_ETC___d67;
  wire IF_NOT_IF_lines_serverAdapter_outData_ff_i_not_ETC___d85,
       IF_lines_serverAdapter_outData_ff_i_notEmpty_T_ETC___d76,
       lines_serverAdapter_cnt_5_SLT_4___d53;

  // action method putFromProc
  assign RDY_putFromProc =
	     reqStatus == 3'd1 && lines_serverAdapter_cnt_5_SLT_4___d53 ;
  ...
  BRAM1 #(.PIPELINED(1'd1),
	  .ADDR_WIDTH(32'd8),
	  .DATA_WIDTH(32'd532),
	  .MEMSIZE(9'd256)) lines_memory(.CLK(CLK),
  ...
  assign WILL_FIRE_RL_clear_bram =
	     lines_serverAdapter_cnt_5_SLT_4___d53 && reqStatus == 3'd0 ;
  ...
  assign WILL_FIRE_RL_waitFillResp =
	     lines_serverAdapter_cnt_5_SLT_4___d53 && memRespQ$EMPTY_N &&
  ...
  assign WILL_FIRE_RL_checkMiss =
	     ...
	     (lines_serverAdapter_outData_ff$EMPTY_N ||
	      lines_serverAdapter_outData_enqw$whas) &&
	     IF_NOT_IF_lines_serverAdapter_outData_ff_i_not_ETC___d85 &&
	     reqStatus == 3'd2 ;

  // inputs to muxes for submodule ports
  assign MUX_lines_memory$put_1__SEL_1 =
	     WILL_FIRE_RL_checkMiss &&
	     IF_lines_serverAdapter_outData_ff_i_notEmpty_T_ETC___d67 !=
	     2'd0 &&
	     IF_lines_serverAdapter_outData_ff_i_notEmpty_T_ETC___d76 &&
	     curReq[538] ;
  ...
  assign lines_serverAdapter_outData_enqw$whas =
	     (!lines_serverAdapter_s2[0] ||
	      lines_serverAdapter_outData_ff$FULL_N) &&
	     lines_serverAdapter_s2[1] &&
	     lines_serverAdapter_s2[0] ;
  assign lines_serverAdapter_cnt_1$whas =
	     (MUX_lines_memory$put_1__SEL_1 || EN_putFromProc ||
	      WILL_FIRE_RL_waitFillResp ||
	      WILL_FIRE_RL_clear_bram) &&
  ...
  // register lines_serverAdapter_s2
  assign lines_serverAdapter_s2$D_IN = lines_serverAdapter_s1 ;
  assign lines_serverAdapter_s2$EN =
	     lines_serverAdapter_s1[1] || lines_serverAdapter_s2[1] ;
  ...
  // submodule lines_memory
  always@(MUX_lines_memory$put_1__SEL_1 or
	  WILL_FIRE_RL_waitFillResp or
	  curReq or
	  EN_putFromProc or
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_lines_memory$put_1__SEL_1 || WILL_FIRE_RL_waitFillResp:
  ...
  // remaining internal signals
  assign IF_NOT_IF_lines_serverAdapter_outData_ff_i_not_ETC___d85 =
	     (IF_lines_serverAdapter_outData_ff_i_notEmpty_T_ETC___d67 !=
	      2'd0 &&
	      IF_lines_serverAdapter_outData_ff_i_notEmpty_T_ETC___d76) ?
	       (curReq[538] ?
		  ...
		  respQ$FULL_N) :
	       ...
	       2'd2 ||
	       memReqQ$FULL_N ;
  assign IF_lines_serverAdapter_outData_ff_i_notEmpty_T_ETC___d67 =
	     lines_serverAdapter_outData_ff$EMPTY_N ?
  ...
  assign IF_lines_serverAdapter_outData_ff_i_notEmpty_T_ETC___d76 =
	     IF_lines_serverAdapter_outData_ff_i_notEmpty_T_ETC___d73 ==
	     curReq[537:520] ;
  assign din_datain_data__h3303 =
  ...
  assign lines_serverAdapter_cnt_5_PLUS_IF_lines_server_ETC___d21 =
	     ...
	     (lines_serverAdapter_cnt_1$whas ? 4'd1 : 4'd0) +
	     (WILL_FIRE_RL_checkMiss ? 4'd15 : 4'd0) ;
  assign lines_serverAdapter_cnt_5_SLT_4___d53 =
	     (lines_serverAdapter_cnt ^ 4'h8) < 4'd12 ;
  assign x__h2832 = MUX_respQ$enq_1__VAL_2 ;
  ...
  begin
	...
	lines_serverAdapter_cnt <= `BSV_ASSIGNMENT_DELAY 4'd0;
	lines_serverAdapter_s1 <= `BSV_ASSIGNMENT_DELAY 2'd0;
	lines_serverAdapter_s2 <= `BSV_ASSIGNMENT_DELAY 2'd0;
	...
	if (lines_serverAdapter_s2$EN)
	  lines_serverAdapter_s2 <= `BSV_ASSIGNMENT_DELAY
	      lines_serverAdapter_s2$D_IN;
  ...
  begin
    ...
    lines_serverAdapter_cnt = 4'hA;
    lines_serverAdapter_s1 = 2'h2;
    lines_serverAdapter_s2 = 2'h2;
    reqStatus = 3'h2;
  end
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  !IF_lines_serverAdapter_outData_ff_i_notEmpty_T_ETC___d76 &&
	  IF_lines_serverAdapter_outData_ff_i_notEmpty_T_ETC___d67 == 2'd2)
